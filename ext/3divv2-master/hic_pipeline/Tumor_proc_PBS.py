...
def make_PBS(sampleid, sra_ids):
	...
	output1.write('$SAMTOOLS view -S {}/{}/{}.merged.bam | python {}/filter_self_reads_stdin.py | $SAMTOOLS view -Sb -t $FAI -o {}/{}/{}.filtered.merged.bam\n'.format(WORKDIR, sampleid, sampleid, BINDIR, WORKDIR, sampleid, sampleid))
	...
	output1.write('python {}/make_feature_normalize.py {}/{}/{}.nodup.sorted.filtered.merged.bam {}/{}/{}.40kb.sort.coverage {} {}\n'.format(BINDIR, WORKDIR, sampleid, sampleid, WORKDIR, sampleid, sampleid, '40000', BINDIR + '/coverage_normalize.R' ))
	"""	
	output1.write('cat {}/{}/*.trans.feature.gz > {}/{}/{}.trans.allchr.feature.gz \n'.format(WORKDIR, sampleid, WORKDIR, sampleid, sampleid))
	output1.write('Rscript {}/trans_coverage_normalize.R {}/{}/{}.trans.allchr.feature.gz\n'.format(BINDIR, WORKDIR, sampleid, sampleid))
