...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"/>
	...
	<main id="main">
		...
		<form id='sendForm' method="post" action="cancerhicView">
			...
			<input type='hidden' id='which_tab' name='which_tab' value='${which_tab }'/>
			...
			<input type='hidden' id='chosen_sv_type' name='chosen_sv_type'/>
		</form>
											...
											<div class="card-body">
												...
												<div class="tab-content">
													<div class="tab-pane fade" id="choose-by-all" role="tabpanel" aria-labelledby="choose-by-all-tab">
														...
														<div class="input-group input-group-sm border border-top-0 px-4 pt-1 pb-4 sample-group-class sample-entire-group-class">
															<div class='col-2'><label class="form-check-label" for="text_sample">Sample</label></div>
														...
														<div class="input-group input-group-sm border border-top-0 border-bottom-0 px-4 pt-1 pb-4 sample-group-class sample-control-group-class">
															<div class='col-2'><label class="form-check-label" for="text_cancer_sample">Case</label></div>
														...
														<div class="input-group input-group-sm border border-top-0 border-bottom-0 px-4 pt-4 pb-1 sample-group-class study-group-class" id="study-group-2">
															<div class='col-2'><label class="form-check-label" for="text_control_study">Study</label></div>
														...
														<div class="input-group input-group-sm border border-top-0 px-4 pt-1 pb-4 sample-group-class sample-case-group-class">
															<div class='col-2'><label class="form-check-label" for="text_normal_sample">Control</label></div>
													...
													<div class="tab-pane fade" id="choose-by-search" role="tabpanel" aria-labelledby="choose-by-search-tab">
														<div class="input-group input-group-sm border border-bottom-0 px-4 pt-4 pb-1 sample-group-class sample-control-group-class">
															<div class='col-2'><label class="form-check-label" for="search_text_cancer_sample">Case</label></div>
														...
														<div class="input-group input-group-sm border border-top-0 px-4 pt-1 pb-4 sample-group-class sample-control-group-class">
															<div class='col-2'><label class="form-check-label" for="search_text_normal_sample">Control</label></div>
														...
														<div class="input-group input-group-sm border px-4 pt-4 pb-4 sample-group-class sample-entire-group-class">
															<div class='col-2'><label class="form-check-label" for="search_text_sample">Sample</label></div>
															<input id='search_text_sample' type="text" class="form-control" placeholder="Ex) Colon and CF7L2" aria-label="Colon and CF7L2">
															<div class="input-group-append">
																<button class="btn btn-outline-secondary dropdown-toggle sample-combobox" type="button" aria-haspopup="true" aria-expanded="false"></button>
															</div>
														</div>
													...
													<div class="tab-pane fade show active" id="choose-by-tree" role="tabpanel" aria-labelledby="choose-by-tree-tab">
														<div class="border rounded p-4">
															<div id="choose-tree-cont1" class="choose-tree">
																<div class="select-tree-title">Case</div>
																<div class="row">
																	<div class="form-group col-md-3">
																      <label for="case-inputType"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Type</label>
																      <select id="case-inputType" class="form-control form-control-sm">
																        <option value="" disabled selected hidden>Choose...</option>
																      </select>
																    </div>
																    
																    <div class="form-group col-md-3">
																      <label for="case-inputName"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Sample property</label>
																      <select id="case-inputName" class="form-control form-control-sm">
																        <option value="" disabled selected hidden>Choose...</option>
																      </select>
																    </div>
																    
																    <div class="form-group col-md-3">
																      <label for="case-inputProperty"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Condition</label>
																      <select id="case-inputProperty" class="form-control form-control-sm">
																        <option value="" disabled selected hidden>Choose...</option>
																      </select>
																    </div>
																    
																     <div class="form-group col-md-3">
																      <label for="case-inputSample"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Sample</label>
																      <select id="case-inputSample" class="form-control form-control-sm">
															...
															<div id="choose-tree-cont2" class="choose-tree">
																<div class="select-tree-title">Control</div>
																<div class="row">
																	<div class="form-group col-md-3">
																      <label for="control-inputType"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Type</label>
																      <select id="control-inputType" class="form-control form-control-sm">
																        <option value="" disabled selected hidden>Choose...</option>
																      </select>
																    </div>
																    
																    <div class="form-group col-md-3">
																      <label for="control-inputName"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Sample property</label>
																      <select id="control-inputName" class="form-control form-control-sm">
																        <option value="" disabled selected hidden>Choose...</option>
																      </select>
																    </div>
																    
																    <div class="form-group col-md-3">
																      <label for="control-inputProperty"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Condition</label>
																      <select id="control-inputProperty" class="form-control form-control-sm">
																        <option value="" disabled selected hidden>Choose...</option>
																      </select>
																    </div>
																    
																     <div class="form-group col-md-3">
																      <label for="control-inputSample"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Sample</label>
																      <select id="control-inputSample" class="form-control form-control-sm">
																        <option value="" disabled hidden>Choose...</option>
																      </select>
																    </div>
																</div>
															...
															<div id="choose-tree-cont3" class="choose-tree">
																<div class="row">
																	<div class="form-group col-md-3">
																      <label for="sample-inputType"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Type</label>
																      <select id="sample-inputType" class="form-control form-control-sm">
																        <option value="" disabled selected hidden>Choose...</option>
																      </select>
																    </div>
																    
																    <div class="form-group col-md-3">
																      <label for="sample-inputName"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Name</label>
																      <select id="sample-inputName" class="form-control form-control-sm">
																        <option value="" disabled selected hidden>Choose...</option>
																      </select>
																    </div>
																    
																    <div class="form-group col-md-3">
																      <label for="sample-inputProperty"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Property</label>
																      <select id="sample-inputProperty" class="form-control form-control-sm">
																        <option value="" disabled selected hidden>Choose...</option>
																      </select>
																    </div>
																    
																     <div class="form-group col-md-3">
																      <label for="sample-inputSample"><i class="fa fa-chevron-right pr-2" aria-hidden="true"></i>Sample</label>
																      <select id="sample-inputSample" class="form-control form-control-sm">
																        <option value="" disabled hidden>Choose...</option>
																      </select>
																    </div>
																</div>
										...
										<div class="card h-100 mt-3">
											...
											<div class="card-body">
												<div class='row w-100'>
													...
													<div class='by_predefined_sv_panel col-lg-12 col-sm-12 mt-3'>
														<div class='card h-100'>
															<div class='card-header text-left'>By predefined SV</div>
																...
																<div class="card bg-light">
																	...
																	<div class="card-body">
																		<div class='form-row'>
																			...
																			<div class="form-check form-check-inline w-100">
																				<input type="checkbox" class="form-check-input" id="refseq_chk" checked>
...
<!-- 																					<a class="dropdown-item boundary-dropdown-item">500Kb</a>
														...
														<div class='row mt-3' id='option_gene'>
															<div class='col mb-1'>
																<div class="card bg-light">
																	<div class="card-header text-left">Genes (Enter the genes to be displayed)</div>
																	<div class="card-body">
																		<textarea class='form-control' id='textarea_option_gene' placeholder='Enter gene.' style='height: 150px;'></textarea>
																	</div>
																</div>
															</div>
														</div>
...
<style>
	.choose-tree > div.row > div.form-group{text-align:left;}
	.select-tree-title{ text-align: left; color: #1b5f86; font-weight: bold; margin-bottom: 5px; }
</style>
